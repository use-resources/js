class MediaPlayer {
  ...
  __constructor(storageName) {
    ...
    const $element = ((html = "") => {
      ...
      <div id="uuid-019548a2-e462-7276-8741-6e59a397cb7b" class="div_vze7xVdMQzHAUh">

        <div class="div_opnxihchj7bt1ph">
            <canvas id="canvas"></canvas>
            <video id="video" src="" style="object-fit: contain;"></video>
        </div>

        <div id="control" class="div_3cpfarn2f85vyoh">
            
            <div class="div_S2OWmrFPAHLAweO">
                <span id="spanLoad" style="width: 100px; height: 100px; position: absolute;">
                    <div class="div_CQM4abRCwN455Mw" style="--color:#ffffff; --pixel:100px"></div>
                </span>
                <span id="spanError" class="span_XGbxfirIjc0LJXf" style="position: absolute; display: none;">
                  ${this.svgIcon("fi fi-rr-exclamation")}
                </span>
            </div>
            <div id="controlNotification" class="div_S2OWmrFPAHLAweO">
                <span id="controlNotificationTouch" class="span_RPtji863vU2iJtm" style="display: none;">
                  2x <small>${this.svgIcon("fi fi-sr-forward-fast")}</small>
                </span>
            </div>
            <label id="divTap" class="label_myh59oz6lsyldmc" data-status="true">
                <input id="inputToggleControl" type="checkbox" checked>
                <div data-action="event-left"></div>
                <div data-action="event-center"></div>
                <div data-action="event-right"></div>
            </label>
            <div id="controlView" class="div_9s7jtd1s87x198k">
                <div class="div_30iEfg1Tp8Z9Sfe" data-control="" style="padding: 10px; gap: 10px; margin-bottom: 10px;">
                    <label class="button_dgli7ygzpy8r4o1 label_n7n9k0firocrrig tag_dye9tkyn5fa1q8k">
                      <input id="inputCheckboxLock" type="checkbox" class="checkbox-toggle-lock" style="display:none">
                      <small class="checked-off">
                        ${this.svgIcon("fi fi-rr-lock")}
                      </small>
                      <small class="checked-on">
                        ${this.svgIcon("fi fi-rr-unlock")}
                      </small>
                    </label>
                    <div class="div_KYTTm4XcCkVvAmy" style="text-align: center;">
                        <div class="div_swkEBnnVsXvSjjL">
                            <p id="videoTitle">Title</p>
                            <span id="videoDescription">Description</span>
                        </div>
                    </div>
                    <button id="openOptions" class="button_dgli7ygzpy8r4o1 checkbox-lock-hidden tag_dye9tkyn5fa1q8k">
                      ${this.svgIcon("fi fi-rr-menu-dots-vertical")}
                    </button>
                </div>
                <div class="div_fqntqCwolU7nS2I checkbox-lock-hidden" data-control="">
                    <button style="display:none"></button>
                    <button id="seekLeft" style="display:none">
                      ${this.svgIcon("fi fi-rr-rotate-left")}
                    </button>
                    <button id="buttonPlay" class="button_0Y7K28nawg1NzgP" style="visibility:hidden">
                      ${this.svgIcon("fi fi-sr-play")}
                    </button>
                    <button id="seekRight" style="display:none">
                      ${this.svgIcon("fi fi-rr-rotate-right")}
                    </button>
                    <button style="display:none"></button>
                </div>
                <div class="div_n7o81w429b8kty7" data-control="">

                    <div class="div_s75qw16xjga5pz6">
                      <div class="div_iVl4urAy8xQ7zk6">
                        <span id="durationBar"></span>
                        <input id="durationInput" type="range" class="checkbox-lock-disable" data-status="false" min="0" value="0" max="0" style="height: 40px;">
                      </div>
                    </div>

                    <div class="div_4R38EJRezM03FeL">
                        <div class="div_y5oh9e1polgfu2m tag_dye9tkyn5fa1q8k">
                            <div id="duration" class="div_quGYBx1MHxIWCd6">
                              <span id="durationText">99:99</span>
                            </div>
                            <hr class="hr_jccist8k9xr9ktn">
                            <label class="button_dgli7ygzpy8r4o1 label_n7n9k0firocrrig checkbox-lock-hidden">
                              <input type="checkbox" id="inputVolumen">
                              <small class="checked-off">
                                ${this.svgIcon("fi fi-rr-volume")}
                              </small>
                              <small class="checked-on">
                                ${this.svgIcon("fi fi-rr-volume-mute")}
                              </small>
                            </label>
                        </div>

                        <div class="div_y5oh9e1polgfu2m checkbox-lock-hidden tag_dye9tkyn5fa1q8k">
                            <label id="buttonRotate" class="button_dgli7ygzpy8r4o1 label_n7n9k0firocrrig" style="display:none">
                              <input type="checkbox" id="inputRotate">
                              <small class="checked-off">
                                ${this.svgIcon("fi fi-rr-refresh")}
                              </small>
                              <small class="checked-on">
                                ${this.svgIcon("fi fi-rr-refresh")}
                              </small>
                            </label>
                            <button id="buttonPIP" class="button_dgli7ygzpy8r4o1 button_ArxpE8UbBze4uwS"
                                data-object-fit="contain" style="display:none">
                                ${this.svgIcon("fi fi-rr-resize")}
                            </button>
                            <button id="buttonResize" class="button_dgli7ygzpy8r4o1 button_ArxpE8UbBze4uwS"
                                data-object-fit="contain">
                                ${this.svgIcon("fi fi-rr-tool-crop")}
                            </button>
                            <hr class="hr_jccist8k9xr9ktn">
                            <button id="buttonFullscreen" class="button_dgli7ygzpy8r4o1 button_ArxpE8UbBze4uwS">
                                ${this.svgIcon(
        ...
        <div id="div-popover" class="div_lh6NqXMBMnAkhJ" popover>
          <div class="div_M8bQe0N9CPqqIy">

            <div class="div_0wgv7xmg98Vw2IY">
              <div class="div_pvsfzyejk5nfu4l">
                <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                  ${this.svgIcon("fi fi-rr-angle-left")}
                </button>
              </div>
              <div class="div_9kll7qq6kw7jki8">

                <div id="divOptionsButtons" class="div_5lgw0Me5IocTECr">
                    <button data-option-action="background">
                      <small>
                        ${this.svgIcon("fi fi-rr-background")}
                      </small>
                      <span>Fondo</span> 
                    </button>
                    <button data-option-action="speed">
                      <small>
                        ${this.svgIcon("fi fi-rr-tachometer-fastest")}
                      </small>
                      <span>Velocidad</span> 
                    </button>
                    <button data-option-action="jumpTime">
                      <small>
                        ${this.svgIcon("fi fi-rr-time-forward")}
                      </small>
                      <span>Tiempo de salto</span> 
                    </button>
                    <button data-option-action="hideControl">
                      <small>
                        ${this.svgIcon("fi fi-rr-hourglass-end")}
                      </small>
                      <span>Ocultar controles</span> 
                    </button>
                    <button data-option-action="events">
                      <small>
                        ${this.svgIcon("fi fi-rr-cursor-finger")}
                      </small>
                      <span>Eventos</span> 
                    </button>
                </div>
        ...
        <div id="div-popover-2" class="div_lh6NqXMBMnAkhJ" popover>
          <div class="div_M8bQe0N9CPqqIy">

            <div id="option-from-background" class="div_0wgv7xmg98Vw2IY" style="display:none">
              <div class="div_pvsfzyejk5nfu4l" style="justify-content:space-between">
                <div class="div_pvsfzyejk5nfu4l" style="padding:0">
                  <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                    ${this.svgIcon("fi fi-rr-angle-left")}
                  </button>
                  <h3>Fondo</h3>
                </div>
                <label class="app-label-input-checkbox">
                  <input id="background-input-checkbox" type="checkbox">
                  <span></span>
                </label>
              </div>
              <div class="div_9kll7qq6kw7jki8">

                <div class="div_s8gvst6gk81pegl">

                  <form id="background-form-input" class="div_tAIppFChF7u7CjX">
                    <label>
                      <input type="radio" name="key" value="50">
                      <span>50px</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="100" checked>
                      <span>100px</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="150">
                      <span>150px</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="200">
                      <span>200px</span>
                    </label>
                  </form> 
                  ...
                  <div class="div_ccWrXBhzP0hqhl5">
                    <div class="div_iVl4urAy8xQ7zk6">
                      <span id="background-span-range"></span>
                      <input id="background-input-range" type="range" min="0" value="150" max="500">
                    </div>
                    <span id="background-span-text" style="width:60px; text-align:center">150px</span>
                  </div>
            ...
            <div id="option-from-speed" class="div_0wgv7xmg98Vw2IY" style="display:none">
              <div class="div_pvsfzyejk5nfu4l">
                <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                  ${this.svgIcon("fi fi-rr-angle-left")}
                </button>
              ...
              <div class="div_9kll7qq6kw7jki8">
                ...
                <div class="div_s8gvst6gk81pegl">
                  ...
                  <form id="speed-form-input" class="div_tAIppFChF7u7CjX">
                    <label>
                      <input type="radio" name="key" value="0.5">
                      <span>0.5x</span>
                    </label>
                    <label>
                    ...
                    <label>
                      <input type="radio" name="key" value="1.5">
                      <span>1.5x</span>
                    </label>
                    <label>
                  ...
                  <div class="div_ccWrXBhzP0hqhl5">
                    <div class="div_iVl4urAy8xQ7zk6">
                      <span id="speed-span-range"></span>
                      <input id="speed-input-range" type="range"  step="0.1" min="0" value="1" max="15">
                    </div>
                    <span id="speed-span-text" style="width:60px; text-align:center">1x</span>
                  </div>
            ...
            <div id="option-from-jumpTime" class="div_0wgv7xmg98Vw2IY" style="display:none">
              <div class="div_pvsfzyejk5nfu4l">
                <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                  ${this.svgIcon("fi fi-rr-angle-left")}
                </button>
                <h3>Tiempo de salto</h3>
              </div>
              <div class="div_9kll7qq6kw7jki8">

                <div class="div_s8gvst6gk81pegl">

                  <form id="jumpTime-form-input" class="div_tAIppFChF7u7CjX">
                    <label>
                      <input type="radio" name="key" value="5">
                      <span>5s</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="10" checked>
                      <span>10s</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="15">
                      <span>15s</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="20">
                      <span>20s</span>
                    </label>
                  </form> 
                  ...
                  <div class="div_ccWrXBhzP0hqhl5">
                    <div class="div_iVl4urAy8xQ7zk6">
                      <span id="jumpTime-span-range"></span>
                      <input id="jumpTime-input-range" type="range" min="0" value="10" max="300">
                    </div>
                    <span id="jumpTime-span-text" style="width:60px; text-align:center">10s</span>
                  </div>
            ...
            <div id="option-from-hideControl" class="div_0wgv7xmg98Vw2IY">
              <div class="div_pvsfzyejk5nfu4l" style="justify-content:space-between">
                <div class="div_pvsfzyejk5nfu4l" style="padding:0">
                  <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                    ${this.svgIcon("fi fi-rr-angle-left")}
                  </button>
                  <h3>Ocultar Control</h3>
                </div>
                <label class="app-label-input-checkbox">
                  <input id="hideControl-input-checkbox" type="checkbox" checked>
                  <span></span>
                </label>
              </div>
              <div class="div_9kll7qq6kw7jki8">
                ...
                <div class="div_s8gvst6gk81pegl">
                  ...
                  <form id="hideControl-form-input" class="div_tAIppFChF7u7CjX">
                    <label>
                      <input type="radio" name="key" value="2">
                      <span>2s</span>
                    </label>
                    <label>
                      <input type="radio" name="key" value="3" checked>
                      <span>3s</span>
                    </label>
                    <label>
                  ...
                  <div class="div_ccWrXBhzP0hqhl5">
                    <div class="div_iVl4urAy8xQ7zk6">
                      <span id="hideControl-span-range"></span>
                      <input id="hideControl-input-range"type="range" min="1" value="3" max="30">
                    </div>
                    <span id="hideControl-span-text" style="width:60px; text-align:center">3s</span>
                  </div>
            ...
            <div id="option-from-events" class="div_0wgv7xmg98Vw2IY">
              <div class="div_pvsfzyejk5nfu4l" >
                <button class="button_dgli7ygzpy8r4o1" data-hide-popover>
                  ${this.svgIcon("fi fi-rr-angle-left")}
                </button>
              ...
              <div class="div_9kll7qq6kw7jki8">
                ...
                <div class="div_s8gvst6gk81pegl" style="gap:0px">
                  
                  <label class="label_0n7nivcq4t84jv9">
                    <div class="div_he2n78bbqmcle0e">
                      <span>doble click izquierdo:</span>
                      <p>Retroceder el tiempo en (n segundos)</p>
                    </div>
                    <div class="app-label-input-checkbox">
                      <input id="input-event-dblclickLeft" type="checkbox" checked>
                      <span></span>
                    </div>
                  </label>
                  ...
                  <label class="label_0n7nivcq4t84jv9">
                    <div class="div_he2n78bbqmcle0e">
                      <span>doble click derecho:</span>
                      <p>Avanzar el tiempo en (n segundos)</p>
                    </div>
                    <div class="app-label-input-checkbox">
                      <input id="input-event-dblclickRight" type="checkbox" checked>
                      <span></span>
                    </div>
                  </label>
                  ...
                  <label class="label_0n7nivcq4t84jv9">
                    <div class="div_he2n78bbqmcle0e">
                      <span>doble click central:</span>
                      <p>Salir/Entrar en pantalla completa</p>
                    </div>
                    <div class="app-label-input-checkbox">
                      <input id="input-event-dblclickCenter" type="checkbox" checked>
                      <span></span>
                    </div>
                  </label>
                  ...
                  <label class="label_0n7nivcq4t84jv9">
                    <div class="div_he2n78bbqmcle0e">
                      <span>mantener presionado:</span>
                      <p>Aumentar velocidad en 2x</p>
                    </div>
                    <div class="app-label-input-checkbox">
                      <input id="input-event-longpress" type="checkbox" checked>
                      <span></span>
                    </div>
                  </label>
                  ...
                  <label class="label_0n7nivcq4t84jv9">
                    <div class="div_he2n78bbqmcle0e">
                      <span>pellizcar:</span>
                      <p>Ajustar pantalla</p>
                    </div>
                    <div class="app-label-input-checkbox">
                      <input id="input-event-pinch" type="checkbox" checked>
                      <span></span>
                    </div>
                  </label>
    ...
    useThis.functions.callbackTryCatch(() => {
      ...
      $video.addEventListener("play", () => {
        $elements.buttonPlay.innerHTML = this.svgIcon("fi fi-sr-pause");
      });
      $video.addEventListener("pause", () => {
        $elements.buttonPlay.innerHTML = this.svgIcon("fi fi-sr-play");
      });
      ...
      $video.addEventListener("seeked", () => {
        ...
        $elements.buttonPlay.innerHTML = this.svgIcon(
    ...
    $element.addEventListener("fullscreenchange", () => {
      $elements.buttonFullscreen.innerHTML = this.svgIcon(
